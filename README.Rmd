...
You can download the compendium as a zip from from this URL: <https://github.com/reconjohn/csss20/archive/master.zip>

Or you can install this compendium as an R package, csss20, from GitHub with:
